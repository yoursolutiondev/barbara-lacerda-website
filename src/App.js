            ...
            {bookingStep === 4 && (
              <div>
                ...
                <div className="bg-pink-50 rounded-lg p-4 mb-6">
                  ...
                  <p className="text-sm text-gray-700"><strong>Serviço:</strong> {selectedService?.name}</p>
                  <p className="text-sm text-gray-700"><strong>Profissional:</strong> {selectedProfessional?.name}</p>
                  <p className="text-sm text-gray-700"><strong>Data:</strong> {selectedDate?.toLocaleDateString('pt-PT', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}</p>
                  <p className="text-sm text-gray-700"><strong>Hora:</strong> {selectedTime}</p>
                  <p className="text-sm text-gray-700"><strong>Duração:</strong> {selectedService?.duration} minutos</p>
                  <p className="text-sm text-gray-700"><strong>Preço:</strong> {selectedService?.price}</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
              ...
              <p className="text-gray-400">Seja uma Mulher Bárbara</p>
            </div>
            <div>
